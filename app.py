...
def predict_skin(file_path):
    ...
    classes = {
        0: 'Actinic Keratosis and Intraepithelial Carcinoma', 1: 'Basal Cell Carcinoma', 2: ' Benign Keratosis-like Lesions', 3: 'Dermatofibroma', 4: 'nv', 5: 'Vascular Lesion', 6: 'Melanoma'
    }
